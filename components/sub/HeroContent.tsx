    ...
    >
      <div className="flex flex-col h-full w-full justify-center m-auto text-start">
        ...
        <motion.a
          ...
          className=" py-2 button-primary text-center text-white text-lg cursor-pointer max-w-[200px]"
          href="Hammad_Farooq_Meer.pdf"
          download
        >
          Resume 
        </motion.a>
